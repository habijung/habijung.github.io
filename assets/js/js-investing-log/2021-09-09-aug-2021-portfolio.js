/* data */
const holdingsType = ['Dividends', 'ETFs', 'Others'];
const holdingsValue = [14278.18, 5217.18, 42836.17];
const holdingsPercent = [22.91, 8.37, 68.72];
const tickers = ["NVDA","MSFT","AAPL","TSM","KO","O","MCD","Others"];
const tickersValue = [2180.23,2123.47,2009.15,1261.04,844.47,797.65,662.17,4400.00];
...
var myChart2 = new Chart(
    document.getElementById('dividendPortfolio'),
    config2
);
